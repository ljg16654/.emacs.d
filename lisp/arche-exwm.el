...
(use-package exwm
  :after (wordnut ace-window consult)
  :init
  (winner-mode -1)
  ...
  (setq exwm-input-global-keys
	...
	(list
	 (cons (kbd "s-<return>")	#'(lambda () (interactive) (arche/raise-or-run "cool-retro-term" "cool-retro-term: ")))
	 ...
	 (cons (kbd "s-SPC")		#'project-find-file)
